...
public class TraditionalRestAssuredPost2 {
	...
	public void testPostRequestTraditional() {
		...
		requestBody.put("price", 1934);
		requestBody.put("description", "This is a Test Body");
		requestBody.put("category", "Test Post Traditional");
		requestBody.put("image", "https://fakestoreapi.com");
